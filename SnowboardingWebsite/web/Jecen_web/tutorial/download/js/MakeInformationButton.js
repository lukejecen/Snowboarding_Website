...
function MakeInformationButton(objList) {
    ...
    function MakeEle(obj) {
        ...
        buttonOpen.innerHTML = "Open Information";
        buttonDiv.appendChild(buttonOpen);
        buttonDiv.style.visibility = "hidden";

        var buttonClose = document.createElement('button');
        buttonClose.innerHTML = "Close Information";
        ...
        buttonOpen.onclick = function () {
            ...
            {
                alert('The information is already Open!');
            } else {
                info.style.visibility = "visible";
            }
        };
        ...
        buttonClose.onclick = function () {
            ...
            {
                alert('The information is already Closed!');
            } else {
                info.style.visibility = "hidden";
            }
        };
    ...
    //container.classList.add("informationButtonStyle");
