function clickSortUserContent() {
    ...
    var userObjects = document.createElement("div");
    ele.appendChild(userObjects);
    ...
    ajax("json/users.json", processData);
    ...
    function processData(userList) {
        ...
        for (var i = 0; i < userList.length; i++) {
            ...
            newUserList[i].Image = SortableTableUtils.makeImage(userList[i].image, ".5 rem");
        ...
        userObjects.appendChild(MakeClickSort("User List", newUserList, "Email", "Jecen_web/icons/smiley.png", "clickSortStyle"));
    }
    return ele;
}